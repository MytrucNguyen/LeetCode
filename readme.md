...
| 66 | <a href="https://leetcode.com/problems/plus-one/">Plus One</a> | <a href="https://github.com/MytrucNguyen/LeetCode/blob/main/JavaScript/64-minimumPathSum.js">You are given a large integer represented as an integer array digits, where each digits[i] is the ith digit of the integer. The digits are ordered from most significant to least significant in left-to-right order. The large integer does not contain any leading 0's. <br><br>Increment the large integer by one and return the resulting array of digits.|
